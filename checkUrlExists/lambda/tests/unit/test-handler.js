...
describe('Tests index', function () {
	...
	const url = "https://this.is.fake.or.private.aws.amazon.com/lambda/latest/dg/welcome.html";
	await setupTest(url, false);
    });
    it('verifies successful response for large file', async() => {
	const url = "https://dcc.icgc.org/api/v1/download?fn=/PCAWG/reference_data/data_for_testing/HCC1143_ds/HCC1143.bam"
	await setupTest(url, true);
    });
});
